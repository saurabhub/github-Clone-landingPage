  ...
  return (
    ...
    <div className='flex items-center justify-between border-b-[0.5px] border-[#30363d] p-4'>
        ...
        <div className='flex items-center justify-between px-2 py-1 rounded-md bg-[#0d1117] border-[0.5px] border-[#30363d] w-full md:w-auto'>
            ...
            <div className='md:px-8 px-2 text-white whitespace-nowrap overflow-hidden text-[14px] text-ellipsis'>github.com/saurabhub/github-Clone</div>
    ...
    <div className='flex items-stretch'>
        ...
        <div className='md:block hidden border-l-[0.5px] border-[#30363d] w-full'>
            ...
            <Image className="w-full h-auto md:block" width="1238" height="1404" loading="lazy" decoding="async" alt="Planet earth with visualization of GitHub activity crossing the globe" src="https://github.githubassets.com/images/modules/site/home/globe.jpg"/>
            </div>
        </div>
    </div>
</div>
